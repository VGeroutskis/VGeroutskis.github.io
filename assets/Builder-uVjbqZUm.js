import{r as p,g as we,D as Ge,C as ve,s as qe,a as Ze,u as pt,l as ut,j as e,R as ht,b as ft,G as Ie,Y as Ae,c as Xe,d as mt}from"./index-Dzu6Srua.js";import{TemplateRenderer as gt}from"./index-BU8H1EqJ.js";import{u as _e}from"./githubSecrets-rYw5YF8o.js";const Qe=()=>new Promise((c,P)=>{if(window.JSZip){c(window.JSZip);return}const N=document.createElement("script");N.src="https://cdnjs.cloudflare.com/ajax/libs/jszip/3.10.1/jszip.min.js",N.onload=()=>c(window.JSZip),N.onerror=()=>P(new Error("Failed to load JSZip CDN")),document.head.appendChild(N)}),bt=async(c,P)=>{try{const N=await Qe(),x=new N;let g=await(await fetch("/")).text();g=g.replace("</head>",`<script>
