import{r as u,g as ve,D as Ge,C as we,s as qe,a as Ze,u as ut,l as pt,j as e,R as ht,b as ft,G as Ae,Y as Ie,c as Xe,d as mt}from"./index-BnEH_BKt.js";import{TemplateRenderer as gt}from"./index-CdaWSbzU.js";import{u as _e}from"./githubSecrets-DTT4BUsC.js";const Qe=()=>new Promise((c,L)=>{if(window.JSZip){c(window.JSZip);return}const C=document.createElement("script");C.src="https://cdnjs.cloudflare.com/ajax/libs/jszip/3.10.1/jszip.min.js",C.onload=()=>c(window.JSZip),C.onerror=()=>L(new Error("Failed to load JSZip CDN")),document.head.appendChild(C)}),bt=async(c,L)=>{try{const C=await Qe(),b=new C;let f=await(await fetch("/")).text();f=f.replace("</head>",`<script>
